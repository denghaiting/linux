...
#define HSE_STARTUP_TIMEOUT   ((uint16_t)0x5000) /*!< Time out for HSE rx_tx_mode up */
...
#define HSI_STARTUP_TIMEOUT   ((uint16_t)0x5000) /*!< Time out for HSI rx_tx_mode up */
...
#define ADC_CR_ADSTART                       ((uint32_t)0x00000004)        /*!< ADC rx_tx_mode of conversion */
